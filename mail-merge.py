...
def send_email(receipient_name, to_address, body_content1, body_content2):  
    body_detailed = body_content2.split(', ')
    # print body_detailed
    i = 0
    mail_sublist = ""
    sizeofList = len(body_detailed)
    while i < sizeofList:
        mail_sublist += body_content1 + "\t" + body_detailed[i] + "\n"
        i += 1
    # print mail_sublist
...
while i < sizeofList:
    send_email(receipient_name[i], receipient_email[i], receipient_body_part1, receipient_body_part2[i])
    i += 1
